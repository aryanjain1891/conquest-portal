        ...
        <div className={styles.links}>
          <div className={styles.quickLinks}>
            <ul>
              ...
              <li>
                <a href={`${MARKETING_SITE_URL}/alumni`}>Alumni</a>
              </li>
              <li>
                <a href={`${MARKETING_SITE_URL}/sponsors-and-partners`}>Sponsors</a>
              </li>
              <li>
                <a href={`${MARKETING_SITE_URL}/partners`}>Resource partners</a>
              </li>
              <li>
                <a href={`${MARKETING_SITE_URL}/mentors`}>Mentors</a>
              </li>
            </ul>
          </div>
          <div className={styles.learnMore}>
            <ul>
              ...
              <li>
                <a href={`${MARKETING_SITE_URL}/about`}>About us</a>
              </li>
              <li>
                <a href={`${MARKETING_SITE_URL}/process`}>Our Process</a>
              </li>
              <li>
                <a href="">Register</a>
              </li>
              <li>
                <a href={`${MARKETING_SITE_URL}/privacy`}>Privacy Policy</a>
              </li>
            </ul>
          </div>
        </div>
