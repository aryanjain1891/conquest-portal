...
export default function MentorProfileHeader({
  ...
  function connectionHandler() {
    if (connectionState === "not-connected") {
      ...
      axios
        .post(
          `${API_BASE_URL}/api/users/connections/send/`,
          {
      ...
      axios
        .post(
          `${API_BASE_URL}/api/users/connections/delete/`,
          {
            id: startupid,
          },
          {
      ...
      axios
        .post(
          `${API_BASE_URL}/api/users/connections/accept/`,
          {
            status: true,
            id: startupid,
          },
  ...
  useEffect(() => {
    if (role1_Startup) {
      axios
        .get(`${API_BASE_URL}/api/meetings/portal_state/`, {
          headers: {
            Authorization: `Bearer ${JSON.parse(localStorage.getItem("tokens")).access
              }`,
          },
