...
export default function WebContextProvider({ children }) {
    ...
    const tokenRefreshFunction = () => {
        ...
        const refreshTokenInterval = setInterval(() => {
            ...
            axios.post(`${API_BASE_URL}/api/users/token/refresh/`, {
    ...
    const usernameLogin = (credentials) => {
        ...
        axios.post(`${API_BASE_URL}/api/users/login/username/`, credentials)
            .then((res) => {
    ...
    const glogin = useGoogleLogin({
        onSuccess: response => {
            ...
            // Send access token
            axios.post(`${API_BASE_URL}/api/users/login/google/`, {
